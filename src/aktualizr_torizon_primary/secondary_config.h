...
class JsonConfigParser : public SecondaryConfigParser {
 ...
 private:
  ...
  static void createTorizonGenericSecondariesCfg(Configs& configs, const Json::Value& json_torizon_generic_sec_cfg);
 ...
 private:
  ...
  SecondaryConfigFactoryRegistry sec_cfg_factory_registry_ = {
      {IPSecondariesConfig::Type, createIPSecondariesCfg}, {VirtualSecondaryConfig::Type, createVirtualSecondariesCfg}, {DockerComposeSecondaryConfig::Type, createDockerComposeSecondariesCfg}, {TorizonGenericSecondaryConfig::Type, createTorizonGenericSecondariesCfg}
